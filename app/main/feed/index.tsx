      ...
      >
        ...
        {featuredItem && (
          <View style={styles.featured}>
            ...
            >
              <Image source={{ uri: featuredItem.previewImage }} style={styles.featuredImage} />
        ...
        {otherItems.map((item, index) => (
          <View key={index} style={styles.recommendationCard}>
            ...
            >
              <Image source={{ uri: item.previewImage }} style={styles.recommendationImage} />
            ...
            <TouchableOpacity style={styles.addButton} onPress={() => handleAddToCollection(item)}>
              <Ionicons name="add-circle-outline" size={20} color="#666" />
            </TouchableOpacity>
          </View>
        ))}
      ...
      <Modal visible={showProjectModal} animationType="slide" presentationStyle="pageSheet">
        <SafeAreaView style={styles.modalContainer}>
          ...
          <ScrollView style={styles.projectsList}>
            {projects.map((project) => (
              ...
              >
                <Image
                  source={{
                    uri: project.imageUrl || 'https://via.placeholder.com/60',
                  }}
          ...
          <View style={styles.modalFooter}>
            <TouchableOpacity
              style={[styles.confirmButton, !selectedProject && styles.confirmButtonDisabled]}
              onPress={handleConfirmAddToProject}
              disabled={!selectedProject}
            >
              <Text style={styles.confirmButtonText}>Adicionar ao projeto</Text>
            </TouchableOpacity>
          </View>
        </SafeAreaView>
      </Modal>
