...
interface HybridTabScreenProps {
    projectCode?: number;
}

export default function HybridTabScreen({ projectCode }: HybridTabScreenProps) {
    ...
    const [activeTab, setActiveTab] = useState<'info' | 'images' | 'links' | 'ai'>('info');
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.tabBar}>
                ...
                >
                    <Text style={styles.tabText}>Projeto</Text>
                </TouchableOpacity>
                <TouchableOpacity
...
const styles = StyleSheet.create({
    ...
    activeTab: { borderBottomColor: '#362946' },
    tabText: { fontSize: 16, fontWeight: 'bold', color: '#362946' },
    tabContent: { flex: 1 },
