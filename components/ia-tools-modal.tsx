          ...
          <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.modeSelector}>
                <TouchableOpacity
                  style={[styles.modeCard, mode === 'audio' && styles.modeCardActive]}
                  onPress={() => setMode('audio')}
                >
                  <View
                    style={[styles.modeIconContainer, mode === 'audio' && styles.modeIconActive]}
                  >
                    <Ionicons
                      name="mic"
                      size={24}
                  ...
                  <Text
                    style={[styles.modeCardText, mode === 'audio' && styles.modeCardTextActive]}
                  >
                    Gravar Áudio
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  style={[styles.modeCard, mode === 'readImage' && styles.modeCardActive]}
                ...
                >
                  ...
                  <Text
                    style={[styles.modeCardText, mode === 'readImage' && styles.modeCardTextActive]}
                  >
                    Ler Imagem
                  </Text>
                </TouchableOpacity>
            ...
            {mode && (
              <View style={styles.contentSection}>
                ...
                {mode === 'readImage' && (
                  <View style={styles.imageSection}>
                    <TouchableOpacity style={styles.imagePickerButton} onPress={pickImage}>
                      ...
                      <Text style={styles.imagePickerSubtext}>Toque para escolher uma imagem</Text>
                    </TouchableOpacity>
                ...
                {(mode === 'audio' || mode === 'readImage') && resultText !== '' && (
                  <View style={{ marginTop: 16, gap: 12 }}>
                    <Text style={styles.sectionTitle}>Transformar em Anotação</Text>
                    ...
                    <TouchableOpacity style={[styles.executeButton]} onPress={saveNote}>
                      <Ionicons name="save" size={20} color="#fff" />
                      <Text style={styles.executeText}>Salvar como Anotação</Text>
                    </TouchableOpacity>
                  </View>
                )}
